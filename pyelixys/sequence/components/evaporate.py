...
class EvaporateThread(ComponentThread):
    ...
    def run(self, evaporate):
        ...
        evaporate.component_status= "Setting pressure regulator 1 to %f" % \
                evaporate.evaporationpressure
        ...
        evaporate.component_status = "Setting pressure regulator 1" \
                                     " to the pressure %f for the" \
                                     " duration of %f" % \
                                     (evaporate.evaporation_pressure,
                                             evaporate.duration)
